...
var require_url_parse = __commonJS({
  'node_modules/url-parse/index.js'(exports, module2) {
    ...
    function Url(address, location, parser) {
      ...
      if (parser && typeof parser !== 'function') parser = qs2.parse;
      ...
      url.origin =
        url.protocol !== 'file:' && isSpecial(url.protocol) && url.host ? url.protocol + '//' + url.host : 'null';
    ...
    function toString(stringify) {
      if (!stringify || typeof stringify !== 'function') stringify = qs2.stringify;
      var query,
        url = this,
...
function findFormula(packDef, formulaNameWithNamespace) {
  ...
  if (!formulas || !formulas.length) {
    throw new Error(
      `Pack definition has no formulas${namespace != null ? namespace : ` for namespace "${namespace}"`}.`,
    );
  }
  ...
  throw new Error(
    `Pack definition has no formula "${name}"${namespace != null ? namespace : ` in namespace "${namespace}"`}.`,
  );
}
...
var recognizableSystemErrorClasses = [Error, EvalError, RangeError, ReferenceError, SyntaxError, TypeError, URIError];
var recognizableCodaErrorClasses = [StatusCodeError];
    ...
    case FormulaType.Metadata: {
      switch (formulaSpec.metadataFormulaType) {
        case MetadataFormulaType.GetConnectionName:
          if (
            (defaultAuthentication == null ? void 0 : defaultAuthentication.type) !== AuthenticationType.None &&
            (defaultAuthentication == null ? void 0 : defaultAuthentication.type) !== AuthenticationType.Various &&
            (defaultAuthentication == null ? void 0 : defaultAuthentication.getConnectionName)
          ) {
        ...
        case MetadataFormulaType.GetConnectionUserId:
          if (
            (defaultAuthentication == null ? void 0 : defaultAuthentication.type) !== AuthenticationType.None &&
            (defaultAuthentication == null ? void 0 : defaultAuthentication.type) !== AuthenticationType.Various &&
            (defaultAuthentication == null ? void 0 : defaultAuthentication.getConnectionUserId)
          ) {
        ...
        case MetadataFormulaType.PostSetupSetEndpoint:
          if (
            (defaultAuthentication == null ? void 0 : defaultAuthentication.type) !== AuthenticationType.None &&
            (defaultAuthentication == null ? void 0 : defaultAuthentication.type) !== AuthenticationType.Various &&
            (defaultAuthentication == null ? void 0 : defaultAuthentication.postSetup)
          ) {
