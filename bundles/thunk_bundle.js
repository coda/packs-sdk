...
module.exports = (() => {
  ...
  var require_util_inspect = __commonJS({
    "node_modules/side-channel/node_modules/object-inspect/util.inspect.js"(exports, module) {
      init_buffer_shim();
  ...
  function wrapError(err) {
    return new Error((0, import_v82.serialize)(marshalValue(err)).toString("base64"));
  }
  function unwrapError(err) {
    try {
      const unmarshaledValue = unmarshalValue((0, import_v8.deserialize)(Buffer2.from(err.message, "base64")));
