...
module.exports = (() => {
  ...
  var require_set_function_length2 = __commonJS({
    "node_modules/set-function-length/index.js"(exports, module) {
      ...
      init_buffer_shim();
      var GetIntrinsic = require_get_intrinsic2();
      var define = require_define_data_property2();
      var hasDescriptors = require_has_property_descriptors2()();
      var gOPD = require_gopd2();
      var $TypeError = require_type2();
      var $floor = GetIntrinsic("%Math.floor%");
      module.exports = /* @__PURE__ */ __name(function setFunctionLength(fn, length) {
  ...
  var require_applyBind2 = __commonJS({
  ...
  var require_call_bind2 = __commonJS({
    "node_modules/call-bind/index.js"(exports, module) {
      "use strict";
      init_buffer_shim();
      var setFunctionLength = require_set_function_length2();
      var $defineProperty = require_es_define_property2();
      var callBindBasic = require_call_bind_apply_helpers2();
      var applyBind = require_applyBind2();
      module.exports = /* @__PURE__ */ __name(function callBind(originalFunction) {
        var func = callBindBasic(arguments);
        var adjustedLength = originalFunction.length - (arguments.length - 1);
        return setFunctionLength(
      ...
      case "Metadata" /* Metadata */: {
        switch (formulaSpec.metadataFormulaType) {
          ...
          case "ValidateParameters" /* ValidateParameters */: {
            const validateParametersFormula = wrapMetadataFunction(
  ...
  __name(findParameterAutocompleteFormula, "findParameterAutocompleteFormula");
  function findValidateParametersFormula(manifest, formulaSpec) {
    const parentFormula = findParentFormula(manifest, formulaSpec);
    return parentFormula?.validateParameters;
  }
  __name(findValidateParametersFormula, "findValidateParametersFormula");
