...
export type PackFormulaValue = $Values<$Omit<TypeMap, Type.object>>;
export type PackFormulaResult = $Values<TypeMap>;
...
export type ParamArgs<T extends Type> = $Omit<ParamDef<T>, 'description' | 'name' | 'type'>;
        ...
        : (ParamDefsT extends [ParamDef<infer A3>, ParamDef<infer B3>, ParamDef<infer C3>]
            ...
            : (ParamDefsT extends [ParamDef<infer A4>, ParamDef<infer B4>, ParamDef<infer C4>, ParamDef<infer D4>]
                ...
                : (ParamDefsT extends [
                    ...
                    ? [TypeMap[A5], TypeMap[B5], TypeMap[C5], TypeMap[D5], TypeMap[E5]]
                    : (ParamDefsT extends [
                        ParamDef<infer A6>,
                        ParamDef<infer B6>,
                        ParamDef<infer C6>,
                        ...
                        ? [TypeMap[A6], TypeMap[B6], TypeMap[C6], TypeMap[D6], TypeMap[E6], TypeMap[F6]]
                        : (ParamDefsT extends [
                            ParamDef<infer A7>,
                            ParamDef<infer B7>,
                            ParamDef<infer C7>,
