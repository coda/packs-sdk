...
- Added a new `arguments` property to our `ExecutionContext` interface so that all formulas, not just metadata formulas, can read formula or sync table arguments.
