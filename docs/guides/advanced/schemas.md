...
```ts
let NumberSchema = sdk.makeSchema({
...
```ts
let MySchema = sdk.makeObjectSchema({
  properties: {
...
let MovieSchema = sdk.makeObjectSchema({
  properties: {
    ...
    year: { type: sdk.ValueType.Number },
...
```ts
let LocationSchema = sdk.makeObjectSchema({
  properties: {
    // These names match exactly what the API returns.
    latDeg: { type: sdk.ValueType.Number },
    longDeg: { type: sdk.ValueType.Number },
  },
  // ...
});
...
let LocationSchema = sdk.makeObjectSchema({
  properties: {
    ...
    latitude: { type: sdk.ValueType.Number, fromKey: "latDeg" },
    longitude: { type: sdk.ValueType.Number, fromKey: "longDeg" },
  },
  // ...
});
...
let LocationSchema = sdk.makeObjectSchema({
  properties: {
    ...
    display: { type: sdk.ValueType.String },
    // ...
  },
...
```ts
let TaskSchema = sdk.makeObjectSchema({
  // ...
  attribution: [
    {
...
Alternatively, you can use the helper function `sdk.withIdentity()` to make a copy of the schema with the identity set. This can allow for better reuse of schemas across your Pack.
...
pack.addFormula({
  ...
  resultType: sdk.ValueType.Object,
  schema: sdk.withIdentity(MovieSchema, "Movie"),
  // ...
});
```
...
```{.ts hl_lines="5"}
let DeviceSchema = sdk.makeObjectSchema({
  properties: {
    iPhone_version: {
      type: sdk.ValueType.String,
...
let MovieSchema = sdk.makeObjectSchema({
  ...
  subtitleProperties: [
    ...
    {
      property: "year",
      label: `Released in ${sdk.PropertyLabelValueTemplate}`,
    },
...
[makeSchema]: ../../reference/sdk/core/functions/makeSchema.md
[makeObjectSchema]: ../../reference/sdk/core/functions/makeObjectSchema.md
...
[PropertyIdentifierDetails]: ../../reference/sdk/core/interfaces/PropertyIdentifierDetails.md
[PropertyLabelValueTemplate]: ../../reference/sdk/core/variables/PropertyLabelValueTemplate.md
[titleProperty]: ../../reference/sdk/core/interfaces/ObjectSchemaDefinition.md#titleproperty
[subtitleProperties]: ../../reference/sdk/core/interfaces/ObjectSchemaDefinition.md#subtitleproperties
[snippetProperty]: ../../reference/sdk/core/interfaces/ObjectSchemaDefinition.md#snippetproperty
[linkProperty]: ../../reference/sdk/core/interfaces/ObjectSchemaDefinition.md#linkproperty
[imageProperty]: ../../reference/sdk/core/interfaces/ObjectSchemaDefinition.md#imageproperty
