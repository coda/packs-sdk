...
!!! go "Go only"
    ...
    Indexing is only supported in :superhuman-go: Go.
...
There are also limits as to how much data can be indexed. See the [Limits section][sync_tables_limits] of the sync tables guide for more information.
