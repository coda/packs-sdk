---
title: "Variable: DataUrlPrefixWithDarkModeSupport"
...
> `const` **DataUrlPrefixWithDarkModeSupport**: `"data:image/svg+xml;supportsDarkMode=1;base64,"` = `'data:image/svg+xml;supportsDarkMode=1;base64,'`
