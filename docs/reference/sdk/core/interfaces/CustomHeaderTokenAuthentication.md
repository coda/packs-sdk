---
title: "Interface: CustomHeaderTokenAuthentication"
...
The header name is defined in the [headerName](#headername) property.
...
> **type**: [`CustomHeaderToken`](../enumerations/AuthenticationType.md#customheadertoken)
