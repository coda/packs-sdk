---
title: "Interface: SyncExecutionContext"
...
- [`PropertyOptionsExecutionContext`](PropertyOptionsExecutionContext.md)
...
[`ExecutionContext`](ExecutionContext.md).[`previousAttemptError`](ExecutionContext.md#previousattempterror)

***

### sync

> `readonly` **sync**: [`Sync`](../type-aliases/Sync.md)\<`SyncContinuationT`, `IncrementalCheckpointContinuationT`, `IncrementalSyncContinuationT`\>
