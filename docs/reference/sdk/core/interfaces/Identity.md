...
The runtime version of [IdentityDefinition](IdentityDefinition.md) with the current Pack ID injected if a different
...
See [ObjectSchemaDefinition.attribution](ObjectSchemaDefinition.md#attribution)
