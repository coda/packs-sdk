---
title: "Interface: NumericDurationSchema"
...
- `BaseNumberSchema`\<[`Duration`](../enumerations/ValueHintType.md#duration)\>
...
A refinement of [DurationSchema.maxUnit](DurationSchema.md#maxunit) to use for rounding the duration when rendering.
