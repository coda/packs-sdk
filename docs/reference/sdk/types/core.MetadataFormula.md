...
Ƭ **MetadataFormula**<`ContextT`, `ResultT`\>: [`BaseFormula`](core.BaseFormula.md)<[[`ParamDef`](../interfaces/core.ParamDef.md)<[`string`](../enums/core.Type.md#string)\>, [`ParamDef`](../interfaces/core.ParamDef.md)<[`string`](../enums/core.Type.md#string)\>], `ResultT`, `ContextT`\> & { `schema?`: `any`  }
...
| `ResultT` | extends [`PackFormulaResult`](core.PackFormulaResult.md) = [`LegacyDefaultMetadataReturnType`](core.LegacyDefaultMetadataReturnType.md) |
