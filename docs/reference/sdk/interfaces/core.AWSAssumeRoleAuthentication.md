...
[networkDomain](core.AWSAssumeRoleAuthentication.md#networkdomain) that this configuration applies to.
...
• **type**: [`AWSAssumeRole`](../enums/core.AuthenticationType.md#awsassumerole)
