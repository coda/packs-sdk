...
search:
  boost: 0.1
---
# Interface: SyncExecutionContext<ContinuationT, IncrementalContinuationT, IncrementalSyncContinuationT\>
...
• `Readonly` **sync**: [`Sync`](../types/core.Sync.md)<`ContinuationT`, `IncrementalContinuationT`, `IncrementalSyncContinuationT`\>
