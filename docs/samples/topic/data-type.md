...
Packs can return various types of values, and apply hints that tell Superhuman Docs how to display that data. Formulas and schema properties must declare these types upfront, and the values you return in your code must match.
