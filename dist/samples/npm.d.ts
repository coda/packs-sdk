...
export declare const versionSchema: import("../schema").ObjectSchema<"url">;
export declare const personSchema: import("../schema").ObjectSchema<"name" | "email">;
export declare const packageSchema: import("../schema").ObjectSchema<"url" | "downloadCount" | "package" | "author" | "versions">;
