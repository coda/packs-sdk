...
${endpointKey ? 'endpointKey is set' : `requiresEndpointUrl is ${requiresEndpointUrl !== null && requiresEndpointUrl !== void 0 ? requiresEndpointUrl : 'not true'}`}`,
    ...
    const mailEventFiltersSchema = zodCompleteStrictObject({
        conditions: z
    ...
    function validateFormulas(schema) {
        return schema
            ...
            const importanceTiers = new Set(Object.values(api_types_7.SuggestionImportance));
            (data.formulas || []).forEach((formula, formulaIndex) => {
                if (formula.purpose !== api_types_4.FormulaPurpose.Suggestions) {
                    return;
                }
                (formula.examples || []).forEach((example, exampleIndex) => {
                    var _a;
                    const result = example.result;
                    const suggestions = (_a = result === null || result === void 0 ? void 0 : result.suggestions) !== null && _a !== void 0 ? _a : result === null || result === void 0 ? void 0 : result.Suggestions;
                    if (!Array.isArray(suggestions)) {
                        return;
                    }
                    suggestions.forEach((suggestion, suggestionIndex) => {
                        var _a;
                        const importance = (_a = suggestion === null || suggestion === void 0 ? void 0 : suggestion.importance) !== null && _a !== void 0 ? _a : suggestion === null || suggestion === void 0 ? void 0 : suggestion.Importance;
