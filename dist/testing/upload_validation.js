...
exports.validateSyncTableSchema =
  exports.validateVariousAuthenticationMetadata =
  exports.validatePackVersionMetadata =
  exports.PackMetadataValidationError =
  exports.PACKS_VALID_COLUMN_FORMAT_MATCHER_REGEX =
    void 0;
    ...
    for (const unionError of subError.unionErrors) {
      const isNonmatchedUnionMember = unionError.issues.some(issue => {
        ...
        return (
          ...
          ((_a = issue.params) === null || _a === void 0 ? void 0 : _a.customErrorCode) ===
      ...
      for (const unionIssue of unionError.issues) {
        const isDiscriminantError =
          ...
          ((_a = unionIssue.params) === null || _a === void 0 ? void 0 : _a.customErrorCode) ===
            CustomErrorCode.NonMatchingDiscriminant;
...
const paramDefValidator = zodCompleteObject({
  ...
  type: z
    .union([
      ...
      z.object({type: zodDiscriminant('array'), items: z.nativeEnum(api_types_3.Type)}),
    ])
    .refine(
      paramType =>
        paramType !== api_types_3.Type.object &&
...
const arrayPropertySchema = z.lazy(() =>
  zodCompleteObject({
...
const genericObjectSchema = z.lazy(() =>
  zodCompleteObject({
    ...basePropertyValidators,
    ...
    .superRefine((data, context) => {
      ...
      if (
        !isValidIdentityName(
          (_a = data.identity) === null || _a === void 0 ? void 0 : _a.packId,
          (_b = data.identity) === null || _b === void 0 ? void 0 : _b.name,
        )
      ) {
        context.addIssue({
  ...
  .refine(
    data => {
      ...
      const usesAuthentication =
        (data.defaultAuthentication && data.defaultAuthentication.type !== types_1.AuthenticationType.None) ||
      ...
      if (
        ((_b = data.defaultAuthentication) === null || _b === void 0 ? void 0 : _b.type) ===
        types_1.AuthenticationType.Various
      ) {
        return true;
      }
      return false;
