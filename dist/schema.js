 ...
 */
var ImageShapeStyle;
(function (ImageShapeStyle) {
    /** Image is rendered normally. */
    ImageShapeStyle["Auto"] = "auto";
    /** Image is rendered as a circle. */
    ImageShapeStyle["Circle"] = "circle";
})(ImageShapeStyle || (exports.ImageShapeStyle = ImageShapeStyle = {}));
/**
...
function normalizeObjectSchema(schema) {
    ...
    const { attribution, options, requireForUpdates, codaType, description, displayProperty, featured, featuredProperties, id, identity, idProperty, entityIdProperty, imageProperty, includeUnknownProperties, linkProperty, primary, properties, snippetProperty, subtitleProperties, titleProperty, type, 
    ...
    return {
        ...
        entityIdProperty: entityIdProperty ? normalizeSchemaKey(entityIdProperty) : undefined,
