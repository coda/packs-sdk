...
(function (IndexingStrategy) {
    IndexingStrategy["Standard"] = "standard";
...
function normalizeObjectSchema(schema) {
    ...
    __packId, createdAtProperty, createdByProperty, modifiedAtProperty, modifiedByProperty, userEmailProperty, userIdProperty, groupIdProperty, memberGroupIdProperty, bodyTextProperty, popularityRankProperty, itemVersionProperty, index, ...rest } = schema;
