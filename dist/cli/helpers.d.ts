...
export declare function spawnProcess(command: string, { stdio }?: SpawnSyncOptionsWithBufferEncoding): import("child_process").SpawnSyncReturns<Buffer<ArrayBufferLike>>;
