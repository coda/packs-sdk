...
function handleRegister({ apiToken, codaApiEndpoint }) {
    return __awaiter(this, void 0, void 0, function* () {
        if (!apiToken) {
            ...
            const shouldOpenBrowser = helpers_3.promptForInput('No API token provided. Do you want to visit Coda to create one? ');
        ...
        try {
            ...
            helpers_2.printAndExit(`Invalid API token provided: ${statusCode} ${message}`);
        }
