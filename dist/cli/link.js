...
export async function handleLink({ manifestDir, codaApiEndpoint, packIdOrUrl }) {
    ...
    if (existingPackId) {
        ...
        const input = promptForInput(`Overwrite existing deploy to pack https://coda.io/p/${existingPackId} with https://coda.io/p/${packId} instead? (y/N): `, { yesOrNo: true });
...
export function parsePackIdOrUrl(packIdOrUrl) {
