 ...
 */
export declare function findAndExecutePackFunction<T extends FormulaSpecification>(params: ParamValues<ParamDefs>, formulaSpec: T, manifest: PackVersionDefinition, executionContext: ExecutionContext | SyncExecutionContext): Promise<T extends SyncFormulaSpecification ? SyncFormulaResult<any> : PackFormulaResult>;
