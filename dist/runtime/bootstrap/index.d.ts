 ...
 */
export declare function injectExecutionContext({ context, fetcher, temporaryBlobStorage, logger, endpoint, invocationLocation, timezone, invocationToken, sync, executionId, previousAttemptError, ...rest }: {
    context: Context;
    fetcher: Fetcher;
