...
declare const ObjectHintValueTypes: readonly [ValueHintType.Person, ValueHintType.Reference];
...
export declare type ObjectSchemaDefinitionType<
  K extends string,
  L extends string,
...
export declare type StringHintTypeToSchemaType<T extends StringHintTypes | undefined> =
  T extends keyof StringHintTypeToSchemaTypeMap ? StringHintTypeToSchemaTypeMap[T] : string;
...
export declare type ObjectSchemaNoFromKeyType<
...
>;
export declare type ObjectSchemaType<T extends ObjectSchemaDefinition<any, any>> = ObjectSchemaNoFromKeyType<T> &
  SchemaFromKeyWildCard<T>;
export declare type SchemaType<T extends Schema> = T extends BooleanSchema
  ? boolean
...
export declare function makeObjectSchema<K extends string, L extends string, T extends ObjectSchemaDefinition<K, L>>(
  schemaDef: T,
): T & {
  identity?: Identity;
};
 ...
 */
export declare function makeReferenceSchemaFromObjectSchema(
...
export declare type TypeOf<T extends PackFormulaResult> = T extends number
  ? Type.number
  : T extends string
  ? Type.string
  : T extends boolean
...
export declare type TypeOfMap<T extends UnionType> = T extends Type
  ? TypeMap[T]
...
export declare type DefaultValueType<T extends UnionType> = T extends ArrayType<Type.date>
...
export declare type ParameterOptions<T extends ParameterType> = Omit<
 ...
 * ```
 */
export declare function makeParameter<T extends ParameterType>(
...
export declare type BaseFormula<ParamDefsT extends ParamDefs, ResultT extends PackFormulaResult> = PackFormulaDef<
  ParamDefsT,
  ResultT
> & {
...
export declare type StringPackFormula<ParamDefsT extends ParamDefs> = BaseFormula<
  ParamDefsT,
  SchemaType<StringSchema>
> & {
  schema?: StringSchema;
};
export declare type ObjectPackFormula<ParamDefsT extends ParamDefs, SchemaT extends Schema> = Omit<
...
export declare type SyncFormula<
  K extends string,
  L extends string,
  ParamDefsT extends ParamDefs,
  SchemaT extends ObjectSchema<K, L>,
 ...
 * ```
 */
export declare function makeFormula<
  ParamDefsT extends ParamDefs,
...
export interface BaseFormulaDefV2<ParamDefsT extends ParamDefs, ResultT extends string | number | boolean | object>
...
export declare type ArrayFormulaDefV2<ParamDefsT extends ParamDefs, SchemaT extends Schema> = BaseFormulaDefV2<
  ParamDefsT,
...
export declare type ObjectFormulaDefV2<ParamDefsT extends ParamDefs, SchemaT extends Schema> = BaseFormulaDefV2<
  ParamDefsT,
  SchemaType<SchemaT>
> & {
  resultType: ValueType.Object;
...
export declare type FormulaResultValueType =
  | ValueType.String
  | ValueType.Number
  | ValueType.Boolean
  | ValueType.Array
  | ValueType.Object;
export declare type FormulaDefinitionV2<
  ParamDefsT extends ParamDefs,
  ResultT extends FormulaResultValueType,
...
export declare type MetadataFunction = <K extends string, L extends string>(
...
export declare function makeMetadataFormula(
...
export declare function simpleAutocomplete(
 ...
 * ```
 */
export declare function autocompleteSearchObjects<T>(
  search: string,
  objs: T[],
  displayKey: keyof T,
  valueKey: keyof T,
 ...
 */
export declare function makeSimpleAutocompleteMetadataFormula(
  options: Array<string | number | SimpleAutocompleteOption>,
): MetadataFormula;
 ...
 */
export declare function makeSyncTable<
  K extends string,
  L extends string,
  ParamDefsT extends ParamDefs,
...
export declare function makeDynamicSyncTable<K extends string, L extends string, ParamDefsT extends ParamDefs>({
  name,
  getName: getNameDef,
 ...
 * });
 */
export declare function makeTranslateObjectFormula<ParamDefsT extends ParamDefs, ResultT extends Schema>({
  response,
  ...definition
...
export declare function makeEmptyFormula<ParamDefsT extends ParamDefs>(
  definition: EmptyFormulaDef<ParamDefsT>,
): {
  description: string;
  name: string;
  parameters: ParamDefsT;
...
export declare type PackSyncTable = Omit<
  SyncTable,
...
export declare type AuthenticationMetadata = DistributiveOmit<
  Authentication,
...
export declare type PackVersionMetadata = Omit<
...
export declare type PackMetadata = PackVersionMetadata &
  Pick<
    PackDefinition,
    | 'id'
    | 'name'
...
export declare type BasePackVersionMetadata = Omit<
  PackVersionMetadata,
...
export declare type ExternalPackMetadata = ExternalPackVersionMetadata &
  Pick<
    PackMetadata,
    | 'id'
    | 'name'
 ...
 * ```
 */
export declare function withQueryParams(
  url: string,
  params?: {
    [key: string]: any;
  },
