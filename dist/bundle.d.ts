...
export interface BaseParentDefinition {
	 ...
	 */
	parentIdentity: IdentityDefinition;
	/**
...
/**
 * Defines that instances of this object will not be generated by crawling parents. Instead, parents for this
 * will be specified in the {@link NotCrawlableParentDefinition.parentIdProperty}.
 */
export interface NotCrawlableParentDefinition extends BaseParentDefinition {
	/**
	 * The name of the property within {@link ObjectSchemaDefinition.properties} that
	 * identifies the parent of this object.
	 *
	 * ValueType.Array is not supported is not supported for parentIdProperty.
	 *
	 * If this property references a property with {@link ValueType.Object} and
	 * {@link ValueHintType.Reference}, then it refers to an object in another logical table.
	 *
	 * Otherwise, it refers to an object in the same table.
	 */
...
/**
 * Defines that this object has a parent object that will be crawled for children.
 */
export interface CrawlableParentDefinition extends BaseParentDefinition {
	/**
	 * Determines how the parent object should be crawled for children.
	 */
	crawling: CrawlingBehavior;
	/**
	 * Determines how the lifecycle of the child objects should be handled.
	 */
 ...
 * @hidden
 */
export type ParentDefinition = CrawlableParentDefinition | NotCrawlableParentDefinition;
/**
 ...
 */
export interface SyncTableDef<K extends string, L extends string, ParamDefsT extends ParamDefs, SchemaT extends ObjectSchema<K, L>, ContextT extends SyncExecutionContext<any, any>> {
 ...
 */
export interface DynamicSyncTableDef<K extends string, L extends string, ParamDefsT extends ParamDefs, SchemaT extends ObjectSchema<K, L>, ContextT extends SyncExecutionContext<any, any>> extends SyncTableDef<K, L, ParamDefsT, SchemaT, ContextT> {
 ...
 */
export type SyncFormula<K extends string, L extends string, ParamDefsT extends ParamDefs, SchemaT extends ObjectSchema<K, L>, ContextT extends SyncExecutionContext<any, any>> = SyncFormulaDef<K, L, ParamDefsT, SchemaT, ContextT> & {
 ...
 */
export interface SyncTableOptions<K extends string, L extends string, ParamDefsT extends ParamDefs, SchemaT extends ObjectSchemaDefinition<K, L>, ContextT extends SyncExecutionContext<any, any>> {
	/**
 ...
 */
export interface DynamicSyncTableOptions<K extends string, L extends string, ParamDefsT extends ParamDefs, SchemaT extends ObjectSchemaDefinition<K, L>, ContextT extends SyncExecutionContext<any, any>> {
	/**
