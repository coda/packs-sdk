...
export interface BaseMakeDynamicSyncTableArgs<ParamDefsT extends ParamDefs> {
	packId: number;
	name: string;
	getName: MetadataFormula;
...
export interface StandardMakeDynamicSyncTableArgs<ParamDefsT extends ParamDefs> extends BaseMakeDynamicSyncTableArgs<ParamDefsT> {
	getSchema: MetadataFormula;
}
export interface InferredMakeDynamicSyncTableArgs<ParamDefsT extends ParamDefs> extends BaseMakeDynamicSyncTableArgs<ParamDefsT> {
	getSchema: never;
	inferSchema: true;
}
export declare function makeDynamicSyncTable<K extends string, L extends string, ParamDefsT extends ParamDefs>(args: StandardMakeDynamicSyncTableArgs<ParamDefsT> | InferredMakeDynamicSyncTableArgs<ParamDefsT>): DynamicSyncTableDef<K, L, ParamDefsT, any>;
