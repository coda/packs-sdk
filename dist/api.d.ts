...
/** @hidden */
export interface TypedSyncFormulaResult<T extends object, ContextT extends SyncExecutionContext<any>, PassthroughT extends SyncPassthroughData> extends SyncFormulaResult<string, string, any, ContextT, PassthroughT> {
    result: T[];
}
/**
...
/** @deprecated */
export declare function makeSyncTableLegacy<K extends string, L extends string, ParamDefsT extends ParamDefs, SchemaT extends ObjectSchema<K, L>, ContextT extends SyncExecutionContext<any, any>, PassthroughT extends SyncPassthroughData>(name: string, schema: SchemaT, formula: SyncFormulaDef<K, L, ParamDefsT, SchemaT, ContextT, PassthroughT>, connectionRequirement?: ConnectionRequirement, dynamicOptions?: {
    getSchema?: MetadataFormula;
    entityName?: string;
}): SyncTableDef<K, L, ParamDefsT, SchemaT, ContextT, PassthroughT>;
/**
