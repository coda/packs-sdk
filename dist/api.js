...
function makeSyncTable({ name, description, identityName, schema: schemaDef, formula, connectionRequirement, dynamicOptions = {}, }) {
    const { getSchema: getSchemaDef, entityName, disableNewColumnsOnSync } = dynamicOptions;
 ...
 * ```
 */
function makeDynamicSyncTable({ name, description, getName: getNameDef, getSchema: getSchemaDef, getDisplayUrl: getDisplayUrlDef, formula, listDynamicUrls: listDynamicUrlsDef, entityName, connectionRequirement, disableNewColumnsOnSync, placeholderSchema: placeholderSchemaInput, }) {
    ...
    const table = makeSyncTable({
        ...
        dynamicOptions: { getSchema, entityName, disableNewColumnsOnSync },
    });
    return {
        ...table,
        isDynamic: true,
