...
class ResponseTooLargeError extends Error {
    // this constructor is no-op but test/typedoc_coverage_test.ts would fail without this.
    /** @hidden */
    constructor(message) {
        super(message);
        /**
