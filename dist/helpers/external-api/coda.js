...
class Client {
    ...
    async getAclMetadata(docId, params = {}) {
        const allParams = {
            ...params,
        };
    ...
    async getAclPermissions(docId, params = {}) {
        const allParams = {
            ...params,
        };
    ...
    async shareDoc(docId, params = {}, payload) {
        const allParams = {
            ...params,
        };
        const codaUrl = url_1.withQueryParams(`${this.protocolAndHost}/apis/v1/docs/${docId}/acl/permissions`, allParams);
    ...
    async packVersionUploadComplete(packId, packVersion, params = {}) {
        const allParams = {
            ...params,
        };
