...
export class Client {
    ...
    async deletePermission(docId, permissionId, params = {}) {
        ...
        const codaUrl = withQueryParams(`${this.protocolAndHost}/apis/v1/docs/${docId}/acl/permissions/${permissionId}`, allParams);
        return this._makeRequest('DELETE', codaUrl);
    }
    ...
    async listPages(docId, params = {}) {
        ...
        const { pageToken, ...rest } = allParams;
        const codaUrl = withQueryParams(`${this.protocolAndHost}/apis/v1/docs/${docId}/pages`, pageToken ? { pageToken } : rest);
        return this._makeRequest('GET', codaUrl);
    }
    ...
    async listTables(docId, params = {}) {
        ...
        const { pageToken, ...rest } = allParams;
        const codaUrl = withQueryParams(`${this.protocolAndHost}/apis/v1/docs/${docId}/tables`, pageToken ? { pageToken } : rest);
        return this._makeRequest('GET', codaUrl);
    }
    ...
    async listColumns(docId, tableIdOrName, params = {}) {
        ...
        const { pageToken, ...rest } = allParams;
        const codaUrl = withQueryParams(`${this.protocolAndHost}/apis/v1/docs/${docId}/tables/${tableIdOrName}/columns`, pageToken ? { pageToken } : rest);
        return this._makeRequest('GET', codaUrl);
    }
    async listRows(docId, tableIdOrName, params = {}) {
        ...
        const { pageToken, ...rest } = allParams;
        const codaUrl = withQueryParams(`${this.protocolAndHost}/apis/v1/docs/${docId}/tables/${tableIdOrName}/rows`, pageToken ? { pageToken } : rest);
        return this._makeRequest('GET', codaUrl);
    }
    async upsertRows(docId, tableIdOrName, params = {}, payload) {
        ...
        const codaUrl = withQueryParams(`${this.protocolAndHost}/apis/v1/docs/${docId}/tables/${tableIdOrName}/rows`, allParams);
        return this._makeRequest('POST', codaUrl, JSON.stringify(payload));
    }
    ...
    async getRow(docId, tableIdOrName, rowIdOrName, params = {}) {
        ...
        const codaUrl = withQueryParams(`${this.protocolAndHost}/apis/v1/docs/${docId}/tables/${tableIdOrName}/rows/${rowIdOrName}`, allParams);
        return this._makeRequest('GET', codaUrl);
    }
    ...
    async pushButton(docId, tableIdOrName, rowIdOrName, columnIdOrName, params = {}) {
        ...
        const codaUrl = withQueryParams(`${this.protocolAndHost}/apis/v1/docs/${docId}/tables/${tableIdOrName}/rows/${rowIdOrName}/buttons/${columnIdOrName}`, allParams);
    ...
    async getColumn(docId, tableIdOrName, columnIdOrName, params = {}) {
        ...
        const codaUrl = withQueryParams(`${this.protocolAndHost}/apis/v1/docs/${docId}/tables/${tableIdOrName}/columns/${columnIdOrName}`, allParams);
        return this._makeRequest('GET', codaUrl);
    }
    async listFormulas(docId, params = {}) {
        ...
        const { pageToken, ...rest } = allParams;
        const codaUrl = withQueryParams(`${this.protocolAndHost}/apis/v1/docs/${docId}/formulas`, pageToken ? { pageToken } : rest);
        return this._makeRequest('GET', codaUrl);
    }
    async getFormula(docId, formulaIdOrName, params = {}) {
        ...
        const codaUrl = withQueryParams(`${this.protocolAndHost}/apis/v1/docs/${docId}/formulas/${formulaIdOrName}`, allParams);
        return this._makeRequest('GET', codaUrl);
    }
    async listControls(docId, params = {}) {
        ...
        const { pageToken, ...rest } = allParams;
        const codaUrl = withQueryParams(`${this.protocolAndHost}/apis/v1/docs/${docId}/controls`, pageToken ? { pageToken } : rest);
        return this._makeRequest('GET', codaUrl);
    }
    async getControl(docId, controlIdOrName, params = {}) {
        ...
        const codaUrl = withQueryParams(`${this.protocolAndHost}/apis/v1/docs/${docId}/controls/${controlIdOrName}`, allParams);
        return this._makeRequest('GET', codaUrl);
    }
    async whoami(params = {}) {
        const allParams = {
    ...
    async triggerWebhookAutomation(docId, ruleId, params = {}, payload) {
        ...
        const codaUrl = withQueryParams(`${this.protocolAndHost}/apis/v1/docs/${docId}/hooks/automation/${ruleId}`, allParams);
        return this._makeRequest('POST', codaUrl, JSON.stringify(payload));
    }
    ...
    async listDocAnalyticsDeprecated(params = {}) {
        ...
        const { pageToken, ...rest } = allParams;
        const codaUrl = withQueryParams(`${this.protocolAndHost}/apis/v1/analytics/docs/legacy`, pageToken ? { pageToken } : rest);
        return this._makeRequest('GET', codaUrl);
    }
    async listDocAnalyticsSummary(params = {}) {
        ...
        const { pageToken, ...rest } = allParams;
        const codaUrl = withQueryParams(`${this.protocolAndHost}/apis/v1/analytics/docs/summary`, pageToken ? { pageToken } : rest);
        return this._makeRequest('GET', codaUrl);
    }
    ...
    async listPackAnalyticsSummary(params = {}) {
        ...
        const { pageToken, ...rest } = allParams;
        const codaUrl = withQueryParams(`${this.protocolAndHost}/apis/v1/analytics/packs/summary`, pageToken ? { pageToken } : rest);
        return this._makeRequest('GET', codaUrl);
    }
    async listPackFormulaAnalytics(packId, params = {}) {
        ...
        const { pageToken, ...rest } = allParams;
        const codaUrl = withQueryParams(`${this.protocolAndHost}/apis/v1/analytics/packs/${packId}/formulas`, pageToken ? { pageToken } : rest);
        return this._makeRequest('GET', codaUrl);
    }
    async listWorkspaceMembers(workspaceId, params = {}) {
        ...
        const { pageToken, ...rest } = allParams;
        const codaUrl = withQueryParams(`${this.protocolAndHost}/apis/v1/workspaces/${workspaceId}/users`, pageToken ? { pageToken } : rest);
        return this._makeRequest('GET', codaUrl);
    }
    ...
    async listWorkspaceRoleActivity(workspaceId, params = {}) {
        ...
        const { pageToken, ...rest } = allParams;
        const codaUrl = withQueryParams(`${this.protocolAndHost}/apis/v1/workspaces/${workspaceId}/roles`, pageToken ? { pageToken } : rest);
        return this._makeRequest('GET', codaUrl);
    }
    ...
    async listPackVersions(packId, params = {}) {
        ...
        const { pageToken, ...rest } = allParams;
        const codaUrl = withQueryParams(`${this.protocolAndHost}/apis/v1/packs/${packId}/versions`, pageToken ? { pageToken } : rest);
        return this._makeRequest('GET', codaUrl);
    }
    ...
    async getPackVersionDiffs(packId, basePackVersion, targetPackVersion, params = {}) {
        ...
        const codaUrl = withQueryParams(`${this.protocolAndHost}/apis/v1/packs/${packId}/versions/${basePackVersion}/diff/${targetPackVersion}`, allParams);
        return this._makeRequest('GET', codaUrl);
    }
    async registerPackVersion(packId, packVersion, params = {}, payload) {
        ...
        const codaUrl = withQueryParams(`${this.protocolAndHost}/apis/v1/packs/${packId}/versions/${packVersion}/register`, allParams);
        return this._makeRequest('POST', codaUrl, JSON.stringify(payload));
    }
    async packVersionUploadComplete(packId, packVersion, params = {}, payload) {
        ...
        const codaUrl = withQueryParams(`${this.protocolAndHost}/apis/v1/packs/${packId}/versions/${packVersion}/uploadComplete`, allParams);
        return this._makeRequest('POST', codaUrl, JSON.stringify(payload));
    }
    ...
    async listPackReleases(packId, params = {}) {
        ...
        const { pageToken, ...rest } = allParams;
        const codaUrl = withQueryParams(`${this.protocolAndHost}/apis/v1/packs/${packId}/releases`, pageToken ? { pageToken } : rest);
        return this._makeRequest('GET', codaUrl);
    }
    ...
    async deletePackPermission(packId, permissionId, params = {}) {
        ...
        const codaUrl = withQueryParams(`${this.protocolAndHost}/apis/v1/packs/${packId}/permissions/${permissionId}`, allParams);
        return this._makeRequest('DELETE', codaUrl);
    }
    async listPackMakers(packId, params = {}) {
        ...
        const { pageToken, ...rest } = allParams;
        const codaUrl = withQueryParams(`${this.protocolAndHost}/apis/v1/packs/${packId}/makers`, pageToken ? { pageToken } : rest);
        return this._makeRequest('GET', codaUrl);
    }
    ...
    async listPackCategories(packId, params = {}) {
        ...
        const { pageToken, ...rest } = allParams;
        const codaUrl = withQueryParams(`${this.protocolAndHost}/apis/v1/packs/${packId}/categories`, pageToken ? { pageToken } : rest);
        return this._makeRequest('GET', codaUrl);
    }
    ...
    async deletePackCategory(packId, categoryName, params = {}) {
        ...
        const codaUrl = withQueryParams(`${this.protocolAndHost}/apis/v1/packs/${packId}/category/${categoryName}`, allParams);
        return this._makeRequest('DELETE', codaUrl);
    }
    ...
    async packAssetUploadComplete(packId, packAssetId, packAssetType, params = {}) {
        ...
        const codaUrl = withQueryParams(`${this.protocolAndHost}/apis/v1/packs/${packId}/assets/${packAssetId}/assetType/${packAssetType}/uploadComplete`, allParams);
        return this._makeRequest('POST', codaUrl);
    }
    async packSourceCodeUploadComplete(packId, packVersion, params = {}, payload) {
        ...
        const codaUrl = withQueryParams(`${this.protocolAndHost}/apis/v1/packs/${packId}/versions/${packVersion}/sourceCode/uploadComplete`, allParams);
        return this._makeRequest('POST', codaUrl, JSON.stringify(payload));
    }
    async getPackSourceCode(packId, packVersion, params = {}) {
        ...
        const codaUrl = withQueryParams(`${this.protocolAndHost}/apis/v1/packs/${packId}/versions/${packVersion}/sourceCode`, allParams);
        return this._makeRequest('GET', codaUrl);
    }
    ...
    async listPackLogs(packId, docId, params = {}) {
        ...
        const { pageToken, ...rest } = allParams;
        const codaUrl = withQueryParams(`${this.protocolAndHost}/apis/v1/packs/${packId}/docs/${docId}/logs`, pageToken ? { pageToken } : rest);
        return this._makeRequest('GET', codaUrl);
    }
    async listGroupedPackLogs(packId, docId, params = {}) {
        ...
        const { pageToken, ...rest } = allParams;
        const codaUrl = withQueryParams(`${this.protocolAndHost}/apis/v1/packs/${packId}/docs/${docId}/groupedLogs`, pageToken ? { pageToken } : rest);
        return this._makeRequest('GET', codaUrl);
    }
