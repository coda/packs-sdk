...
export declare const PluginListingSchema: z.ZodObject<{
    ...
    components: z.ZodRecord<z.ZodString, z.ZodDiscriminatedUnion<[z.ZodObject<{
        ...
        uses: z.ZodDefault<z.ZodArray<z.ZodObject<{
            component: z.ZodString;
            formulas: z.ZodOptional<z.ZodArray<z.ZodObject<{
                formulaName: z.ZodString;
            }, z.core.$strict>>>;
        }, z.core.$strict>>>;
...
export declare function validatePluginComponentType(componentName: string, component: PluginListing['components'][string], metadata: PackVersionMetadata): void;
export type PluginComponentMetadata = Record<string, PackVersionMetadata>;
export declare function validatePluginComponentMetadata(listing: PluginListing, componentMetadata: PluginComponentMetadata): void;
...
export declare function planPluginPublish(pluginJsonPath: string, componentMetadata?: PluginComponentMetadata): PluginPublishPlan;
