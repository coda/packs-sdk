...
pack.addDynamicSyncTable({
  ...
  formula: {
    ...
    parameters: [
      coda.makeParameter({type: coda.ParameterType.String, name: 'myParam', description: 'My description'}),
    ],
    async execute([param]) {
      return {result: [
        {
