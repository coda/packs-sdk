...
if [ "$CURRENT_VERSION" = "$MAIN_VERSION" ]; then
  ...
  echo ""
  echo "If this PR doesn't touch the SDK itself (e.g. docs-only or CI-only changes), you can skip this"
  echo "check instead by adding the 'skip-version-check' label to the pull request."
  echo ""
