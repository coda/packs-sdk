...
typedoc:
	...
	${ROOTDIR}/node_modules/.bin/typedoc index.ts --options documentation/typedoc/sdk.js --gitRevision "${DOC_GIT_REVISION}" --out ${ROOTDIR}/docs/reference/sdk
	node -r ts-node/register documentation/scripts/typedoc_post_process.ts "docs/reference/sdk"

	${ROOTDIR}/node_modules/.bin/typedoc development.ts --options documentation/typedoc/testing.js --gitRevision "${DOC_GIT_REVISION}" --out ${ROOTDIR}/docs/reference/testing
	node -r ts-node/register documentation/scripts/typedoc_post_process.ts "docs/reference/testing"
