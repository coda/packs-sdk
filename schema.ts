        ...
        items: makeObjectSchema({
          properties: {
            id: {
              type: ValueType.String,
              description:
                'Stable identifier for this finding across runs, so the same finding updates in ' +
            ...
            contextBefore: {
              type: ValueType.String,
              description:
                'A distinctive string copied verbatim from before `original`, used to pick the ' +
